...
namespace UI.Popup
{
    ...
    public class InGameUI : InGameEventHadlerMono
    {
        ...
        public override void HandleSkillCardEvent(object _sender, nxGoStopEvent _event)
        {
            ...
            InGameEffectType inGameEffectType = InGameEffectType.STEAL_KWANG;

            if (handleEvent.mainType == CardMainType.KWANG)
                inGameEffectType = InGameEffectType.STEAL_KWANG;
            else if (handleEvent.mainType == CardMainType.MUNG)
                inGameEffectType = InGameEffectType.STEAL_MUNG;
            else if (handleEvent.mainType == CardMainType.DDI)
                inGameEffectType = InGameEffectType.STEAL_DDI;
            else if (handleEvent.mainType == CardMainType.PEE)
                inGameEffectType = InGameEffectType.STEAL_PEE;
