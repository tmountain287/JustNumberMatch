...
namespace Gostop.UI
{
    public class GamblerScoreBoard : MonoBehaviour
    {
        ...
        public void CheckNewIcon()
        {
            ...
            newObj.SetActive(idList.Count > 0);
        }

        public void SetProfile(int _characterID)
        {
            CharacterResManager.Instance.SetImage(profile, TableDataManager.Instance.TableCharacterData.GetCharacterTableData(_characterID).resource, CharacterImage.Type.Profile);         
        }
