...
public static class GameConstants
{
    ...
    public static int PrefsValue { get => (int)PlayerPrefsManager.Instance.GetPlayerPrefsValue(PrefsKey.GAME_SPEED, 2); }
...
public class MissionInfo
{
    ...
    public MissionInfo(List<int> _cardList, string _name)
    {
        CardList = _cardList;
        Name = _name;
    }
...
{
    public static List<MissionInfo> MissionDataList { get => missionDataList; }

    private static readonly List<MissionInfo> missionDataList = new()
    {
        new MissionInfo(new List<int>{0, 8, 28}, "3광"),
        new MissionInfo(new List<int>{0, 8, 40}, "3광"),
        new MissionInfo(new List<int>{0, 8, 44}, "비3광"),
        new MissionInfo(new List<int>{0, 28, 40}, "3광"),
        new MissionInfo(new List<int>{0, 28, 44}, "비3광"),
        new MissionInfo(new List<int>{0, 40, 44}, "비3광"),
        new MissionInfo(new List<int>{8, 28, 40}, "3광"),
        new MissionInfo(new List<int>{8, 28, 44}, "비3광"),
        new MissionInfo(new List<int>{8, 40, 44}, "비3광"),
        new MissionInfo(new List<int>{28, 40, 44}, "비3광"),

        new MissionInfo(new List<int>{4, 12, 29 }, "고도리"),
        new MissionInfo(new List<int>{21, 33, 37 }, "청단"),
        new MissionInfo(new List<int>{1, 5, 9 }, "홍단"),
        new MissionInfo(new List<int>{13, 17, 25 }, "초단"),
    };
}
