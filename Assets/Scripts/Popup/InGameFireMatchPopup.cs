...
namespace Gostop.UI
{
    public class InGameFireMatchPopup : BasePopup
    {
        ...
        [SerializeField] private Image character1 = null;
        [SerializeField] private Image character2 = null;
        ...
        public void Initialize(CharacterTableData _data1, CharacterTableData _data2, bool _useTicket, bool _isDebug = false)
        {
            ...
            CharacterResManager.Instance.SetImage(character1, _data1.resource, CharacterImage.Type.Fire_Left);
            CharacterResManager.Instance.SetImage(character2, _data2.resource, CharacterImage.Type.Fire_Right);
        ...
        public void PlayAnimation()
        {
            ...
            Color charColor = character1.color;
            charColor.a = 0f;
            character1.color = charColor;

            Color charColor2 = character2.color;
            charColor2.a = 0f;
            character2.color = charColor2;
            ...
            sequence.Join(character2.DOFade(1f, 0.2f));
            // pivot2 이동
            sequence.Append(pivot2.DOLocalMoveX(-285f, 0.2f).SetEase(Ease.OutBack));
            sequence.Join(character1.DOFade(1f, 0.2f));
