...
namespace JustOneMatch.UI
{
    public class AdRemovePopup : BasePopup
    {
        ...
        protected override void Start()
        {
            ...
            ProductCatalogData productCatalogData = TableDataManager.Instance.TableProductCatalogData.ProductCatalogDataList.Where(x => x.isPremium == true && x.value == 0).FirstOrDefault();
