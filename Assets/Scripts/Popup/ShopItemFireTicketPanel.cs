...
namespace Gostop.UI
{
    public class ShopItemFireTicketPanel : MonoBehaviour
    {        
        [SerializeField] private Button button = null;
        [SerializeField] private Text bonusText = null;
        [SerializeField] private Text ticketText = null;
        ...
        public void SetPanel(ProductCatalogData _data, Action _onClick)
        {
            ...
            ticketText.text = $"불꽃승부 {_data.fireTicket}개";
            bonusText.text = $"+{_data.gold.FormatComma()}";
